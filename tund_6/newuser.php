<?php
  ...
  if (isset($_POST["birthMonth"]) and !empty($_POST["birthMonth"])){
	  ...
	  $birthMonthError = "Palun sisesta oma s�nnikuu!";
  }
  ...
  if (isset($_POST["birthDay"]) and !empty($_POST["birthDay"])){
	  ...
	  $birthDayError = "Palun sisesta oma s�nnip�ev!";
  }
  ...
  if (isset($_POST["birthYear"]) and !empty($_POST["birthYear"])){
	  ...
	  $birthYearError = "Palun sisesta oma s�nniaasta!";
  }
  ...
  if (isset($_POST["email"]) and !empty($_POST["email"])){
	  ...
	  $emailNameError = "Palun sisesta oma e-mail!";
  }
